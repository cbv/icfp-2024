...
//   - renamed .inc files to .h
//   - inline some stuff from config.h to keep it simple
//   - delete absl namespace
//   - move from absl/numeric to base/
...
#define ABSL_IS_LITTLE_ENDIAN 1
#else
#error Define ABSL_IS_LITTLE_ENDIAN=1 or ABSL_IS_BIG_ENDIAN=1.
#endif
...
class numeric_limits<uint128> {
 public:
  ...
  static constexpr uint128(max)() { return Uint128Max(); }
...
// Example:
//
//     float y = int128(17);  // Error. int128 cannot be implicitly
//                                  // converted to float.
//
//     int128 v;
//     int64_t i = v;                        // Error
...
class numeric_limits<int128> {
 public:
  ...
  static constexpr int128(min)() { return Int128Min(); }
  static constexpr int128 lowest() { return Int128Min(); }
  static constexpr int128(max)() { return Int128Max(); }
...
#if defined(ABSL_HAVE_INTRINSIC_INT128)
#include "base/int128-have-intrinsic.h"
#else  // ABSL_HAVE_INTRINSIC_INT128
#include "base/int128-no-intrinsic.h"
#endif  // ABSL_HAVE_INTRINSIC_INT128
